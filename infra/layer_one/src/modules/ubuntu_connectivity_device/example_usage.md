...
or single line
```
ansible-playbook src/modules/ubuntu_worker/build_infrastructure.yml -vv --extra-vars '{"resource_group_name":"tim-rg-d", "vnet_name":"vnet-d", "subnet_name":"tim-rg-d-subnet-1", "location":"westus", "username":"braveheart", "password":"P@ssword1234!", "machine_name":"devUbuntu3", "machine_size":"Standard_B2s", "module_id", "111" }' -vv
