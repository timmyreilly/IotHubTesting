...
if ($spApp) { # service principal found. Check roles required
    ...
    if ($enableContributor) {
        Write-Host "We're going to assign the role contributor"
...
Write-Host "We're about to do some az ad sp list --filter "
